  ...
  return (
	<div>
        ...
        <section className="Join">
            ...
            <div className="AboutRoadMap1">Standard projects that have roadmaps only to spread false hope & unmet expectations is NOT what we are going for. Our team is built on vision & we want our community to see the vision that we have & help create a positive movement around our vision. </div>
            <div className="AboutRoadMap2">We have big plans for The CR3W & CR3W Museum! We plan to innovate & adapt to whatever comes our way because our ultimate responsibility is to bring value to the NFT community & to spread positivity to others.  </div>
            <div className="AboutRoadMap3">This is our obligation, along with our pledge to the NFT community that we will live up to our word! Although we think that Roadmaps have a bad wrap we do believe that it is important to share with the community some of our big plans: </div>
        </section>
